...
app.post('/chat', async (req, res) => {
    ...
    try {
        const response = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyDfrv2jNKwCVT2V5WYSNtCa1lS52sQE_3M`, {
            method: 'POST',
            headers: {
